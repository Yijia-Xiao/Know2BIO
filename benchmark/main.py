...
parser.add_argument(
    "--valid", default=10, type=float, help="Number of epochs before validation"
)
parser.add_argument(
    "--rank", default=512, type=int, help="Embedding dimension"
)
parser.add_argument(
...
parser.add_argument(
    "--dtype", default="single", type=str, choices=["single", "double"], help="Machine precision"
)
parser.add_argument(
...
def train(args):
    save_dir = get_savedir(args.model, args.dataset, f"bth{args.batch_size}-neg{args.neg_sample_size}-lr{args.learning_rate}")
